...
Reacting is not the same as adding an independent agenda. A question is one way to react and it is often natural, but it must directly concern the specific fact the consultant just gave you; taking it in and saying what you now think is just as complete a reply. The rules below about not appending your own agenda and keeping closed topics closed still apply exactly as written.
